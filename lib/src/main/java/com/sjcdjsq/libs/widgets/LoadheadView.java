...
public class LoadheadView extends FrameLayout implements IHeaderView {
    ...
    public LoadheadView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        refreshTextView.setTextColor(Color.BLACK);
        addView(rootView);
    }
