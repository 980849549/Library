package com.game.aircraft.game;
...
//            gameView.addSprite(yellowBullet);
            ...
            Bitmap blueBulletBitmap = gameView.getYellowBulletBitmap();
            ...
            float offset = getWidth() / 4;
            float leftX = x - offset;
            float leftX2 = x - 2 * offset;
            float rightX = x + offset;
            float rightX2 = x + 2 * offset;
            ...
            //左边的第二发子弹
            Bullet leftBlueBullet2 = new Bullet(blueBulletBitmap);
            leftBlueBullet2.moveTo(leftX2, y);
            gameView.addSprite(leftBlueBullet2);
            ...
            //右边的第二发子弹
            Bullet rightBlueBullet2 = new Bullet(blueBulletBitmap);
            rightBlueBullet2.moveTo(rightX2, y);
            gameView.addSprite(rightBlueBullet2);
